...
int main() {
    ...
    while(1) {
        ...
        sprintf(query, "INSERT INTO SessionLogs(type, value, status) VALUES ('Average', %s, \'%s\')", average, response_status);
        ...
        sprintf(query, "INSERT INTO SessionLogs(type, value, status) VALUES ('Covariance', %s, \'%s\')", average, response_status);
